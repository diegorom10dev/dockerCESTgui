...
* [2.1 Single Patient Mode](/cest_ui-user-manual/demo-mode/single-patient) — Process and classify one lesion at a time for a selected demo patient.
* [2.2 Batch Mode](/cest_ui-user-manual/demo-mode/batch-mode) — Run automated inferences across multiple demo patients and lesions simultaneously.
