...
## 4.2 Existing Account Password Reset
...
Log in with the admin credentials below, then click **Log In**:
...
Click the **Go** button next to the Action dropdown. Log out of the admin interface by clicking **LOG OUT** in the top-right corner.
...
To return to the application's landing page manually, change the browser URL back to:
