...
#### Welcome to the CEST UI User Manual. This guide walks you through installing the application and using all of its features, including Demo Mode, User Mode, and account management.
...
<div style="display:grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin: 24px 0;">
  ...
  <a href="#/cest_ui-user-manual/installation" style="text-decoration:none; color:inherit; border:1px solid #e0e0e0; border-radius:8px; overflow:hidden; display:block;">
    <img src="https://images.unsplash.com/photo-1570215171323-4ec328f3f5fa?w=400&q=80" style="width:100%; height:160px; object-fit:cover;" />
    <div style="padding: 10px 14px; font-size:14px; color:#e05a3a;">Installation Instructions</div>
  </a>
  ...
  <a href="#/cest_ui-user-manual/demo-mode/" style="text-decoration:none; color:inherit; border:1px solid #e0e0e0; border-radius:8px; overflow:hidden; display:block;">
    <img src=".gitbook/assets/Demo2.1.5.gif" style="width:100%; height:160px; object-fit:cover;" />
    <div style="padding: 10px 14px; font-size:14px; color:#e05a3a;">Demo Mode</div>
  </a>
  ...
  <a href="#/cest_ui-user-manual/user-mode/" style="text-decoration:none; color:inherit; border:1px solid #e0e0e0; border-radius:8px; overflow:hidden; display:block;">
    <img src=".gitbook/assets/User3.1.1.gif" style="width:100%; height:160px; object-fit:cover;" />
    <div style="padding: 10px 14px; font-size:14px; color:#e05a3a;">User Mode</div>
  </a>
